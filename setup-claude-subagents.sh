...
# Setup script for MedHelp Claude Code Subagents
# This script configures specialized AI agents for the MedHelp healthcare platform

echo "🚀 Setting up MedHelp Claude Code Subagents..."
...
# Create the subagents configuration
cat > ~/.claude/medhelp-subagents.json << 'EOF'
{
  "subagents": {
    "medhelp-api": {
...
echo "✅ Subagents configuration created at ~/.claude/medhelp-subagents.json"

# Update Claude settings to include the subagents
echo ""
echo "📝 To activate these subagents in Claude Code:"
echo ""
echo "1. Open Claude Code settings with: /settings"
echo ""
echo "2. Add the following to your settings.json:"
echo ""
cat << 'INSTRUCTIONS'
{
  "subagents": {
...
echo ""
echo "3. Copy the full content from ~/.claude/medhelp-subagents.json"
echo ""
echo "🎯 Usage Examples:"
echo ""
echo "  Use @medhelp-api to create a new API endpoint"
echo "  Use @stripe-payments to implement payment features"
echo "  Use @ui-components to build React components"
echo "  Use @testing-qa to write tests"
echo "  Use @bug-investigator to debug issues"
echo "  Use @code-reviewer after making changes"
echo ""
echo "📚 Full documentation available in: claude-subagents.json"
echo ""
echo "✨ Setup complete! Your MedHelp Claude Code subagents are ready to use."